...
var vocab = ['ария','розетка','роза','корт','крот','коза','кета','рота','теза','затор','тора','терка','катер','карт','трек','река','актер','азот','энциклопедия','плед','полдник','полиция','полк','плод','пион','пеон','пинок','пилон','подлец','депо','дикция','линия','лекция','лицо','японец','ялик','клип','кино','клоп','конец','клон','клин','копия','кондиция','опция','циклоп','цикл','циклон','циник','идол','преодоление','реле','ирод','период','предел','подол','продление','продол','плеер','перо','полено','пионер','пеон','прение','поле','пони','пение','деление','дело','доплер','доение','донор','дрон','оперение','одоление','ореол','лидер','аккредитация','тире','традиция','итерация','идея','ядрица','кредит','ката','кара','карета','карта','кедр','китаец','кредитка','каретка','крик','кирка','карате','критик','акация','акция','акарицид','арка','редакция','реакция','радиация','ракета','дата','дирекция','драка','диарея','тирада','терция','триада','цирк','цитра','цикада','дитя','диета'];
